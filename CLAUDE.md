...
The library supports DaVinci Resolve 18.6+ through 21.1.0 and tracks API changes across versions. See `CHANGELOG.md` for version-specific feature additions and the evolution from DR 18.6 through 21.1.0.
